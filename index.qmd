...
Each forward shows a significant jump in Player Load per Minute from practice to game, but the size of that increase varies by athlete. Athletes G and J exhibit the largest disparities, with game loads more than doubling their practice outputs, while Athlete L’s game load remains relatively closer to their practice level. This leads us to believe that while trends may exist across all forwards, creating individualized practice, training, and recovery plans for players could be beneficial.
